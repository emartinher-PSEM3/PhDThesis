...
\begin{document}
	...
	\affil[b]{Oak Ridge Institute for Science and Education, hosted by U.S. Environmental Protection Agency, Office of Research and Development, Cincinnati, Ohio 45268, United States}
	
	\affil[c]{Office of Research and Development, National Risk Management Research Laboratory. U.S. Environmental Protection Agency, 26 West Martin Luther King Drive, Cincinnati, Ohio 45268, United States}
	
	\affil[ ]{}
	
	\affil[*]{mariano.m3@usal.es}
...
\begin{sidewaystable}
	\centering
	\caption{Statistical summary of cattle organic waste composition. Data from \protect\shortcite{Alburquerque,Bolzonella,Seppala,Gell,Normak,Sorensen,Tampere,Moset,Zheng,Xia,Moller,WRAP,ADAS,Risgberg,Ledda,Kirchmann,Moller2,Walsh,Loes,Martin2}.} \label{table:dig_compt_stats}
...
\begin{figure}[H]
	...
	\begin{subfigure}[t]{0.45\textwidth}
		\includegraphics[width=\linewidth]{N_dist.pdf} 
		\caption{Nitrogen mass fraction (wet basis).}
		\label{fig:N_KDE}
	\end{subfigure}
	\qquad
	\begin{subfigure}[t]{0.45\textwidth}
		\includegraphics[width=\linewidth]{NH4_frac_dist.pdf}
		\caption{Ammonia/nitrogen ratio (mass basis).}
		\label{fig:NH4_frac_KDE}
	\end{subfigure}
	
	\begin{subfigure}[t]{0.45\textwidth}
		\includegraphics[width=\linewidth]{P_dist.pdf}
		\caption{Phosphorus mass fraction (wet basis).}
		\label{fig:P_KDE}
	\end{subfigure}
	\qquad
	\begin{subfigure}[t]{0.45\textwidth}
		\includegraphics[width=\linewidth]{PO4_frac_dist.pdf}
...
%\section{Thermodynamic model algorithm flowsheet}
%\begin{figure}[H] 
%	\centering
%	\includegraphics[width=\textwidth,height=\textheight,keepaspectratio, trim=1cm 9cm 1cm 5cm, clip]{algorithm_flowsheet_w_squares_SUPERREDUCED} 
%	\caption{Flowsheet of the proposed algorithm to solve the thermodynamic model of solid compound formation in cattle organic waste.} \label{fig:alg_flow}
%\end{figure}
%
%Figure \ref{fig:alg_flow} shows a flowsheet describing the proposed algorithm to solve the thermodynamic model of solid compound formation in cattle organic waste. The algorithm solution starts with the definition of the operating conditions and the initial molar concentrations of $Ca^{2+}$, $K^{+}$, $Mg^{2+}$, $NH_{4}^{+}$ and $PO_{4}^{3-}$, as described previously, square \emph{a}. Once the initial data are set, ionic strength and activity coefficients are computed, square \emph{b}. Then, two parallel problems are solved, the equilibrium of the aqueous species, square \emph{c}, and the alkalinity problem to determine the distribution of carbonates, square \emph{d}. After determining the concentration of all species in the organic waste, the supersaturation index is computed for all species, square \emph{e}. The compound with the maximum supersaturation index is considered to precipitate first, its corresponding precipitation equilibrium is calculated, and the amount of formed solid compound. As a result of the precipitate formation, the concentration of aqueous phase species changes. Therefore, the equilibrium of the aqueous species and the alkalinity problem must be recalculated, obtaining the new concentration  values of the different compounds in the waste, and the iterative process, square \emph{f}, starts again.

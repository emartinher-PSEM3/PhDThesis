...
\chapter{Appendix C: Supplementary Information of Chapter 4}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.6\linewidth, trim={0.5cm 0cm 0cm 0cm},clip]{gfx/AppendixC/screwpress_cost_m} 
...
In the SMAA method, the feasible space of each weight is explored through the Monte Carlo method \citep{tervonen_implementing_2007}, retrieving a set of weights for all criteria according to the assigned order. Fig. \ref{fig:SMAA_weights} shows the feasible weight space for a problem with three criteria. 
\begin{figure}[h]
	\centering

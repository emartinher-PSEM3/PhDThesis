...
%	\begin{adjustwidth}{}{}
	...
	\resizebox{0.95\columnwidth}{!}{
		\begin{threeparttable}
			\begin{tabular}{@{}ccccccc@{}}
				\toprule
				Components        & Units     & \begin{tabular}[c]{@{}c@{}}Sow \\ Gestating\end{tabular} & \begin{tabular}[c]{@{}c@{}}Sow \\ Lactating\end{tabular} & Boar & \begin{tabular}[c]{@{}c@{}}Piglets \\ Nursery\end{tabular} & \begin{tabular}[c]{@{}c@{}}Piglets Grow \\ to Finish\end{tabular} \\ \midrule
				Animals:AU      & ratio     & 2.67          & 2.67          & 2.67 & 9.09            & 9.09                   \\
...
\begin{tabular}{@{}ccccc@{}}
	\toprule
	Membrane model & Flow capacity (m\textsuperscript{3}/h) & Diameter (m) & Lenght (m) & Cost (USD) \\ \midrule
...
%either
in packed towers.
%or in bubble column reactors, see Section \ref{section:bubblestripping}.
Gaseous ammonia is further recovered through acidic scrubbing, as described in Section \ref{section:AcidicScrubbingNRecoveryPaper}.
...
\begin{table}[h] 
	...
	\begin{tabular}{@{}cccc@{}}
		\toprule
		\multirow{2}{*}{System} & \multirow{2}{*}{Correlation} &\multicolumn{1}{c}{\begin{tabular}[c]{@{}c@{}}Waste processing cost\\  $\left(\sfrac{\text{USD}}{\text{kg}_{\text{waste processed}}}\right)$\end{tabular}} & \multicolumn{1}{c}{\begin{tabular}[c]{@{}c@{}}Total nitrogen recovery cost\\  $\left(\sfrac{\text{USD}}{\text{kg}_{\text{N recovered}}}\right)$\end{tabular}} \\ \cmidrule(l){3-3}\cmidrule(l){4-4} 
		&       &       Parameters   &   Parameters                \\  \midrule
		%		\cmidrule(l){2-3}
		%		\cmidrule(r){1-1}
		%		Digestate drying 
		Ammonia evaporation 

...
%\smallskip
\textbf{Keywords:} Organic waste; Phosphorus; Nutrient pollution; Struvite; Thermodynamics
...
\begin{figure}[h!] 
	\begin{adjustwidth}{}{}
		\centering
		\includegraphics[width=0.75\linewidth, trim=0.5cm 0cm 1cm 1cm, clip]{gfx/Chapter3/Contour_plot_mod.pdf} 
